...
**Important:** when you clone this repository, you need to copt the contents of a subdirectory and move it to you personal project folder. Otherwise, `npm run ...` commands will always return a `sh: command not found` error! Take a look at https://www.youtube.com/watch?v=AE6pEd1Dqtc if you don't know how to do this.
